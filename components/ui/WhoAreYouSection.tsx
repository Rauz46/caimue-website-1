...
const BrandOwnerCard = () => {
    ...
    return (
        ...
        >
            ...
            {/* Orbiting Social Icons Container - Moved to Top Right with Creative Positioning */}
            <div className="absolute -top-10 -right-10 w-[280px] h-[280px] flex items-center justify-center pointer-events-none opacity-80 scale-110">
                {/* Manual Orbit Paths */}
                <svg className="absolute inset-0 w-full h-full pointer-events-none opacity-40">
                    <circle cx="50%" cy="50%" r="60" fill="none" stroke="rgba(76, 29, 149, 0.2)" strokeWidth="1" />
                    <circle cx="50%" cy="50%" r="90" fill="none" stroke="rgba(76, 29, 149, 0.2)" strokeWidth="1" />
                </svg>
                ...
                >
                    <div className="w-12 h-12 rounded-xl bg-gradient-to-br from-amber-600 to-amber-800 shadow-2xl flex items-center justify-center relative">
                        <div className="w-8 h-1.5 bg-amber-400 rounded-sm absolute top-2" />
                        <div className="w-3 h-1 bg-amber-300 rounded-sm absolute top-0.5" />
                    </div>
                </motion.div>
            ...
            {/* Content area - Pinned to Top Left */}
            <div className="relative z-10 p-8 pt-10 h-full flex flex-col justify-between">
...
const ArtistCard = () => {
    ...
    return (
        ...
        >
            ...
            {/* Orbiting Team Faces Container - Moved to Top Right with Creative Positioning */}
            <div className="absolute -top-10 -right-10 w-[280px] h-[280px] flex items-center justify-center pointer-events-none opacity-90 scale-110">
                {/* Center video icon */}
                <motion.div
                ...
                <OrbitingCircles
                    className="size-10 border-2 border-purple-400/50 bg-transparent overflow-hidden"
                    duration={18}
                    delay={0}
                    radius={60}
                    path={true}
                ...
                <OrbitingCircles
                    className="size-10 border-2 border-pink-400/50 bg-transparent overflow-hidden"
                    duration={18}
                    delay={9}
                    radius={60}
                    path={false}
                ...
                <OrbitingCircles
                    className="size-11 border-2 border-cyan-400/50 bg-transparent overflow-hidden"
                    radius={90}
                    duration={22}
                    delay={0}
                    reverse
                ...
                <OrbitingCircles
                    className="size-11 border-2 border-yellow-400/50 bg-transparent overflow-hidden"
                    radius={90}
                    duration={22}
                    delay={11}
                    reverse
