                    ...
                    <AnimatePresence>
                        {hoveredIndex === item.id && (
                            <motion.div
                                ...
                                className="absolute -top-11 left-1/2 z-50 flex -translate-x-1/2 flex-col items-center justify-center rounded-md bg-black px-2.5 py-1 text-xs shadow-xl"
                            >
                                ...
                                <div className="text-[9px] text-white/80">{item.designation}</div>
                            </motion.div>
                        )}
                    </AnimatePresence>
                    <img
