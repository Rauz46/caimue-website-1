...
const GlowCard: React.FC<GlowCardProps> = ({
    ...
    useEffect(() => {
        const syncPointer = (e: PointerEvent) => {
            ...
            if (cardRef.current) {
                ...
                // Calculate relative coordinates for better control within the card
        ...
        // Listen on window to capture movements accurately but calculate relative to card
    ...
    const getInlineStyles = () => {
        const baseStyles: React.CSSProperties & Record<string, any> = {
            ...
            '--radius': '14',
            '--border': '3',
            '--backdrop': 'hsl(0 0% 10% / 0.12)', // Subtle dark backdrop
            '--backup-border': 'var(--backdrop)',
            '--size': '400', // Increased spotlight size for better visibility
            '--outer': '1',
  ...
  `;
    ...
    return (
        <>
          ...
          p-4 
          backdrop-blur-[5px]
          transition-shadow duration-300 hover:shadow-purple-500/20
          ${className}
        `}
            >
                <div ref={innerRef} data-glow aria-hidden="true"></div>
