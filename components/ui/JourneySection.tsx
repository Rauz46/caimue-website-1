                            ...
                            <CardBody className="relative h-full w-full">
                                ...
                                >
                                    <GlowCard
                                        glowColor="purple"
                                        customSize={true}
                                        className="h-full bg-white/80 backdrop-blur-sm border border-purple-100 rounded-[24px] p-2 md:p-3 flex flex-col relative overflow-hidden group shadow-[0_10px_30px_-15px_rgba(76,29,149,0.1)]"
                                    >
