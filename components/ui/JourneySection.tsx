                ...
                <div className="container mx-auto px-4 relative z-10">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 mx-auto relative z-10">
                        ...
                        <motion.div
                            ...
                            className="relative"
                        >
                            <div className="relative h-full rounded-[24px] border border-purple-100 p-2 md:p-3 bg-white/80 backdrop-blur-sm shadow-[0_10px_30px_-15px_rgba(76,29,149,0.1)]">
                                <GlowingEffect
                                    spread={40}
                                    glow={true}
                                    disabled={false}
                                ...
                                <div className="relative flex h-full flex-col overflow-hidden rounded-[20px] p-[30px] md:p-[40px]">
                                    <div className="relative z-10 h-full flex flex-col">
                                        <div className="absolute -top-10 -right-10 opacity-[0.08] rotate-12 z-0 pointer-events-none">
                                            <Film size={160} />
                                        </div>
                                        ...
                                        {/* Header */}
                                        <div className="flex items-start justify-between gap-4 mb-4 relative z-10 w-full">
                                        ...
                                        {/* Interactive Gallery */}
                                        <div className="h-[280px] w-full relative z-10 mt-auto rounded-xl overflow-hidden border border-gray-100/50 bg-gray-50/50">
                        ...
                        >
                            <div className="relative h-full rounded-[24px] border border-purple-100 p-2 md:p-3 bg-white/80 backdrop-blur-sm shadow-[0_10px_30px_-15px_rgba(76,29,149,0.1)]">
                                ...
                                <div className="relative flex h-full flex-col overflow-hidden rounded-[20px] p-[30px] md:p-[40px]">
                                    <div className="relative z-10 h-full flex flex-col">
                                        {/* Icon */}
                                        <div className="absolute top-6 right-6 z-20 bg-white/50 p-2 rounded-full backdrop-blur-sm border border-purple-50">
                                            <Briefcase className="w-[28px] h-[28px] text-[#F59E0B]" strokeWidth={2} />
                                        </div>

                                        <div className="absolute -top-10 -left-10 opacity-[0.05] z-0 pointer-events-none">
                                            <Briefcase size={160} />
                                        </div>
