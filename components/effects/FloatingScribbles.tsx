        ...
        <div className="absolute inset-0 pointer-events-none z-10 overflow-hidden">
            ...
            >
                <div className="relative rotate-[-6deg]">
                    <span className="font-handwriting text-3xl text-[var(--accent)] font-medium tracking-wide blur-[0.5px]">
                        Action!
                    </span>
                    <svg width="40" height="20" viewBox="0 0 40 20" fill="none" className="absolute -bottom-4 left-2 text-[var(--accent)] opacity-70">
            ...
            >
                <div className="flex items-center gap-2 rotate-[4deg]">
                    ...
                    <span className="font-handwriting text-2xl text-[var(--accent)] font-medium blur-[0.3px]">
                        Rolling...
                    </span>
                </div>
            </motion.div>
            ...
            >
                <div className="relative rotate-[-3deg]">
                    ...
                    <svg width="80" height="10" viewBox="0 0 80 10" fill="none" className="absolute top-full left-0 text-[var(--accent)]">
            ...
            >
                <div className="relative rotate-[5deg] text-center">
                    <span className="text-[var(--accent)] text-lg block mb-1">✦</span>
                    <span className="font-handwriting text-xl text-[var(--accent)] leading-tight blur-[0.4px]">
            ...
            >
                <svg width="60" height="60" viewBox="0 0 60 60" fill="none" className="text-[var(--accent)] blur-[0.6px]">
            ...
            >
                <div className="relative rotate-[-2deg] border border-[var(--accent)] rounded px-2 py-1 opacity-60">
                    <span className="font-handwriting text-sm text-[var(--accent)]">Scene 01</span>
                </div>
            </motion.div>
            ...
            >
                <div className="relative">
                    <svg width="40" height="40" viewBox="0 0 40 40" fill="none" className="text-[var(--accent)]">
                    ...
                    <span className="absolute top-full left-1/2 -translate-x-1/2 text-[10px] text-[var(--accent)] pt-1 font-mono tracking-widest uppercase">Focus</span>
                </div>
            </motion.div>
            ...
            >
                <div className="flex items-center gap-1">
                    ...
                    <span className="font-mono text-[10px] text-[var(--accent)] tracking-widest">REC</span>
                </div>
            </motion.div>
            ...
            >
                <div className="flex items-center gap-2 -rotate-3">
                    <span className="font-handwriting text-sm text-[var(--accent)]">Sound On</span>
                    <div className="flex items-center gap-[2px]">
                        {[4, 8, 12, 6, 10].map((h, i) => (
                            <motion.div
                                ...
                                style={{ height: h }}
                                className="w-[1.5px] bg-[var(--accent)]"
                            />
                        ))}
                    </div>
                </div>
            ...
            >
                <div className="border border-[var(--accent)] rounded-sm px-1.5 py-0.5">
                    <span className="font-mono text-[10px] text-[var(--accent)] font-bold">4K</span>
                </div>
            </motion.div>
        </div>
    );
