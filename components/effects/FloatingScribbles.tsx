        ...
        <div className={`absolute inset-0 pointer-events-none z-0 overflow-hidden ${color}`}>
            ...
            >
                <div className="relative rotate-[-6deg]">
                    <span className={`font-handwriting text-3xl font-medium tracking-wide blur-[0.5px]`}>
                        Action!
                    </span>
                    <svg width="40" height="20" viewBox="0 0 40 20" fill="none" className="absolute -bottom-4 left-2 opacity-70">
            ...
            >
                <div className="flex items-center gap-2 rotate-[4deg]">
                    ...
                    <span className="font-handwriting text-2xl font-medium blur-[0.3px]">
                        Rolling...
                    </span>
                </div>
            </motion.div>
            ...
            >
                <div className="relative rotate-[-3deg]">
                    <span className="font-handwriting text-xl blur-[0.4px]">
                        Built to scale
                    </span>
                    <svg width="80" height="10" viewBox="0 0 80 10" fill="none" className="absolute top-full left-0">
            ...
            >
                <div className="relative rotate-[5deg] text-center">
                    ...
                    <span className="font-handwriting text-xl leading-tight blur-[0.4px]">
            ...
            >
                <svg width="60" height="60" viewBox="0 0 60 60" fill="none" className="blur-[0.6px]">
            ...
            >
                <div className="relative rotate-[-2deg] border border-current rounded px-2 py-1 opacity-60">
                    <span className="font-handwriting text-sm">Scene 01</span>
                </div>
            </motion.div>
            ...
            >
                <div className="relative">
                    <svg width="40" height="40" viewBox="0 0 40 40" fill="none" className="">
                    ...
                    <span className="absolute top-full left-1/2 -translate-x-1/2 text-[10px] pt-1 font-mono tracking-widest uppercase">Focus</span>
                </div>
            </motion.div>
            ...
            >
                <div className="flex items-center gap-1">
                    ...
                    <span className="font-mono text-[10px] tracking-widest">REC</span>
                </div>
            </motion.div>
            ...
            >
                <div className="flex items-center gap-2 -rotate-3">
                    <span className="font-handwriting text-sm">Sound On</span>
            ...
            >
                <div className="border border-current rounded-sm px-1.5 py-0.5">
